...
import 'package:flutter_application_4/model/AuthTokens.dart';
import 'package:flutter_application_4/model/MemberData.dart';
import 'package:flutter_application_4/model/User.dart';
import 'package:http/http.dart' as http;

class Login_Register_service {
  static String URL = "http://localhost:1001/api/v1/user";
